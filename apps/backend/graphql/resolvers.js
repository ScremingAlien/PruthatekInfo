...
import TagPagePageController from './controller/Specific_TagPage.controller.js'
export const resolvers = {
  ...
  Query: {
    ...
    TagPageSliderLeftSide: async (_, { ...arg }) => TagPagePageController.sliderMain({ ...arg }),
    TagPageLatestBlogsBar: async (_, { ...arg }) => TagPagePageController.latestBlogsBar({ ...arg }),
    TagPageSponserd_Blogs: async (_, { ...arg }) => TagPagePageController.Sponserd_Blogs({ ...arg }),
