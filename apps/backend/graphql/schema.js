...
TagPageSliderLeftSide(tag:String): [BlogHomePage]
TagPageLatestBlogsBar(tag:String): [BlogHomePage]
TagPageSponserd_Blogs(tag:String): [BlogHomePage]
...
navbarDropDown(tags:[String]):  [Tag]
